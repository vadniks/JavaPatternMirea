...
public class tsk19 {
    ...
    { SpringApplication.run(tsk19.class, args); }
    ...
    $$$<T extends _$, R extends $$$$<T>> implements $$<T, R> {
        ...
        @Override public List<T> gal() { lg(); return rp.findAll(); }
        @Override public void dd(T a) { lg(); rp.save(a); }
        @Override public void dl(int a) { lg(); rp.deleteById(a); }
        ...
        private void lg() {
            ...
            log.info(a[4].getMethodName() + '.' + a[2].getMethodName());
        }
    }
